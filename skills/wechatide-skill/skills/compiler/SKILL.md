---
name: compiler
description: 负责编译：项目编译、单文件编译、编译到指定页面、构建 npm、刷新模拟器。Use for WeChat mini-program compilation, single-file checks, page-targeted builds, npm builds, simulator refresh, and compile-result inspection.
---
