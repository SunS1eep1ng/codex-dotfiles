---
name: initializer
description: 初始化微信开发者工具开发环境与基础信息。用于项目窗口打开或接管、登录信息获取、AppID 信息获取以及运行时上下文读取。Use for initializing WeChat DevTools, opening or taking over project windows, checking login and AppID details, and reading runtime context.
---
