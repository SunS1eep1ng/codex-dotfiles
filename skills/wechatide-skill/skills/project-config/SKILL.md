...
description: >-
  ...
  Use for directly reading or editing WeChat mini-program or mini-game project configuration,
  including domain checks, hot reload, compilation, upload compression, roots, AppID,
  base-library versions, and compile type.
---
