...
description: >-
  ...
  Use for directly reading or editing WeChat mini-program project configuration,
  including domain checks, hot reload, compilation, upload compression, roots,
  AppID, and base-library settings, without invoking WeChat DevTools.
---
