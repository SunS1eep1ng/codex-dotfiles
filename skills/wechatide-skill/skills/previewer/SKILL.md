---
name: previewer
description: 负责预览和发布：推送手机预览、生成预览码、真机预览、上传代码包。Use for WeChat mini-program preview and release workflows, including phone preview, QR codes, real-device preview, and code-package upload.
---
