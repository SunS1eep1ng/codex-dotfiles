...
description: 微信开发者工具任务执行的根入口。用于在执行前先完成环境检查，再路由到预览、自动化、调试与云相关操作。Root entrypoint for WeChat DevTools tasks. Use for environment checks and routing to preview, UI automation, debugging, CloudBase, and related mini-program workflows.
metadata:
