...
name: ui-ux-pro-max
description: >-
  This skill should be used when the user asks to design or review a UI, create a landing page or dashboard,
  choose colors or typography, improve accessibility, or implement polished frontend interfaces with a clear
  design system. 中文触发词：UI设计、UX评审、界面优化、配色、字体、可访问性、设计系统、dashboard、landing page、前端美化、产品界面。
version: 0.2.0
---
