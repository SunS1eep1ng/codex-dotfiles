...
name: matplotlib
description: >-
  Low-level plotting library for full customization. Use when you need fine-grained control over every plot
  element, creating novel plot types, or integrating with specific scientific workflows. Export to PNG/PDF/SVG for
  publication. For quick statistical plots use seaborn; for interactive plots use plotly; for publication-ready
  multi-panel figures with journal styling, use scientific-visualization.
  中文触发词：matplotlib画图、Python绘图、科研图、折线图、柱状图、散点图、多子图、导出PDF/SVG/PNG、精细控制图表样式。
