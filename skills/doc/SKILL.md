...
name: "doc"
description: >-
  Use when the task involves reading, creating, or editing `.docx` documents, especially when formatting or layout
  fidelity matters; prefer `python-docx` plus the bundled `scripts/render_docx.py` for visual checks.
  中文触发词：Word文档、docx、生成报告、修改Word、文档排版、格式保真、目录、页眉页脚、表格、批注、渲染检查、中文文档。
---
