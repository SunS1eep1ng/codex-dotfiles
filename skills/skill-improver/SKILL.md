...
name: skill-improver
description: >-
  This skill should be used when the user asks to "apply skill improvements", "update skill from plan", "execute
  improvement plan", "fix skill issues", "implement skill recommendations", or mentions applying improvements from
  quality review reports. Reads improvement-plan-{name}.md files generated by skill-quality-reviewer and
  intelligently merges and executes the suggested changes to improve Claude Skills quality.
  中文触发词：改进skill、更新skill、修skill、应用改进计划、优化触发词、修改SKILL.md、提升技能质量、合并改进建议。
version: 1.0.0
---
