...
name: transformers
description: >-
  This skill should be used when working with pre-trained transformer models for natural language processing,
  computer vision, audio, or multimodal tasks. Use for text generation, classification, question answering,
  translation, summarization, image classification, object detection, speech recognition, and fine-tuning models
  on custom datasets. 中文触发词：Transformers、Hugging Face、预训练模型、NLP、文本生成、分类、问答、翻译、摘要、微调、多模态、语音识别。
