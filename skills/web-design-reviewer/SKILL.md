...
description: >-
  ...
  Detects issues with responsive design, accessibility, visual consistency, and layout breakage, then performs
  fixes at the source code level. 中文触发词：检查网页设计、UI评审、布局问题、响应式问题、视觉一致性、可访问性、界面不好看、修页面样式、设计问题定位。
version: 0.1.0
---
