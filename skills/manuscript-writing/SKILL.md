...
description: >-
  Use when revising or reviewing scientific, technical, or academic manuscripts, proposals, abstracts, reports, or
  related writing for precision, concision, logical cohesion, citation support, evidence alignment, and objective
  scholarly tone. 中文触发词：学术手稿、论文修订、摘要润色、引言修改、方法部分、实验部分、讨论部分、逻辑衔接、学术表达、投稿前修改、proposal、report。
---
