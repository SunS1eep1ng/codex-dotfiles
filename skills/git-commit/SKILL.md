...
name: git-commit
description: >-
  Stages and commits changes using Conventional Commits format (local only, no push).
  中文触发词：提交代码、创建commit、帮我commit、Conventional Commit、本地提交、stage改动、生成提交信息、不push。
