...
description: >-
  Complete automated literature discovery pipeline: multi-source search → six-dimension scoring → fine reading →
  formatted delivery → archival. Combines a configurable engine with daily cron-driven application layer. Works
  with Feishu, Telegram, or any messaging platform. 中文触发词：自动文献发现、每日文献推送、文献管线、持续追踪研究热点、多源检索、文献评分、精读推送、本地归档、定期查文献。
version: 1.0.0
author: 十五 (JL Lab)
license: MIT
metadata:
