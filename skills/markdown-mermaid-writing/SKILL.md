...
description: >-
  Comprehensive markdown and Mermaid diagram writing skill. Use when creating any scientific document, report,
  analysis, or visualization. Establishes text-based diagrams as the default documentation standard with full
  style guides (markdown + mermaid), 24 diagram type references, and 9 document templates.
  中文触发词：Markdown文档、Mermaid图、流程图、架构图、时序图、UML、报告结构、复习材料、Typora兼容、Markdown排版、图文说明。
