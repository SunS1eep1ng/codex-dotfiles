...
name: peer-review
description: >-
  Structured manuscript/grant review with checklist-based evaluation. Use when writing formal peer reviews with
  specific criteria methodology assessment, statistical validity, reporting standards compliance (CONSORT/STROBE),
  and constructive feedback. Best for actual review writing, manuscript revision. For evaluating claims/evidence
  quality use scientific-critical-thinking; for quantitative scoring frameworks use scholar-evaluation.
  中文触发词：论文审稿、同行评审、审稿意见、评审报告、方法学评估、统计有效性、报告规范、CONSORT、STROBE、基金评审、给修改建议。
