...
name: bug-detective
description: >-
  This skill should be used when the user asks to "debug this", "fix this error", "investigate this bug",
  "troubleshoot this issue", "find the problem", "something is broken", "this isn't working", "why is this
  failing", or reports errors/exceptions/bugs. Provides systematic debugging workflow and common error patterns.
  中文触发词：debug、修bug、报错、异常、失败、卡住、闪退、不工作、排查问题、定位根因、复现问题、测试失败、为什么不对、修复这个错误。
version: 0.1.0
---
