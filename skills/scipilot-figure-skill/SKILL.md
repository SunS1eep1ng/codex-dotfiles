...
description: >-
 ...
 不做示意图、流程图、架构图。
 Use for scientific data visualization, publication-quality figures, chart
 selection from CSV, Excel, or DataFrames, exploratory data profiling before
 plotting, journal-ready matplotlib/seaborn/plotly charts, statistical
 annotations, colorblind-safe palettes, vector export, and rendered figure QA.
 Trigger when the user asks what chart to use, how to visualize data, or to
 create or review paper figures. Do not use for schematics, flowcharts, or
