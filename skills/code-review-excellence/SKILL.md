...
description: >-
  This skill should be used when the user asks to review a diff or pull request, write review comments, audit code
  quality, establish review standards, or improve how a team performs code review. 中文触发词：代码审查、review代码、审查diff、PR
  review、找潜在bug、风险评估、缺少测试、代码质量、可维护性、安全隐患、给审查意见。
version: 0.1.0
---
