...
description: >-
  ...
  presentations, seminar talks, research presentations, thesis defense slides, or any scientific talk. Provides
  slide structure, design templates, timing guidance, and visual validation. Works with PowerPoint and LaTeX
  Beamer. 中文触发词：科研汇报PPT、学术报告、会议报告、答辩slides、组会PPT、论文汇报、研究展示、Beamer、PowerPoint科研演示。
