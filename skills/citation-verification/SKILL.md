...
description: >-
  This skill provides reference guidance for citation verification in academic writing. Use when the user asks
  about "citation verification best practices", "how to verify references", "preventing fake citations", or needs
  guidance on citation accuracy. This skill supports ml-paper-writing by providing detailed verification
  principles and common error patterns. 中文触发词：核验引用、检查参考文献真假、防止假引用、引用是否准确、DOI是否真实、文献是否存在、参考文献核查、论文引用审计。
